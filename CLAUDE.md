...
The goal of the project is to create an open-source MCP server that builds a Retrieval Augmented Generation (RAG) system over personal documents. The system should enable users to efficiently search, retrieve, and generate information based on their own data using advanced language models. The project will be able to use different RAG types such as traditional RAG, contextual RAG, graph RAG and more. The system should be modular, extensible, and easy to use, allowing users to customize their RAG experience according to their needs. It will be designed so that it can be connected to various LLM providers, including open-source models and commercial APIs.
...
- **Document experiments**: Keep track of what works and what doesn't. Use a .md as a laboratory notebook/journal to keep notes on experiments, findings, and hypotheses. Update it regularly.
- **Use version control**: Commit changes frequently with clear messages.
- **Use literature** to inform decisions: Read relevant papers, articles, and documentation to guide your implementation choices.
...
- **Use conda environment** (the virtual environment) whenever executing Python commands, including for unit tests.
...
Use Serena as a powerful MCP server for semantic code analysis and editing.

```bash
# Install Serena if not already installed
...
# If a package isn’t on pip, you can fall back to: pip install <package>
...
- Conda Documentation: https://docs.conda.io/projects/conda/en/stable/user-guide/index.html
...
- **RESEARCHER NEVER GUESS** - Back up decisions with evidence or references
